...
atab2 <- atab[order(atab$cultivar), ]
...
```{r prune, fig.cap='Improved French prune models in California.', warning=FALSE, echo=FALSE, fig.height=8}

triplot(psl, 'French', loc=TRUE, threshold=74, asmooth=TRUE,
        bsmooth=TRUE, csmooth=TRUE)
