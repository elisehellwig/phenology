...
opts_chunk$set(tidy.opts=list(width.cutoff=60), stringsAsFactors=FALSE)
options(warn=0)
...
#data
weather <- read.csv(file.path(data3, 'weatherlocations.csv'))
...
af <- read.csv(file.path(data2, 'almondfloweringdata.csv'))
pf <- read.csv(file.path(data2, 'prunefloweringdata.csv'))
wf <- read.csv(file.path(data2, 'walnutfloweringdata.csv'))

asl <- read.csv(file.path(data2, 'almondseasonlengthdata.csv'))
psl <- read.csv(file.path(data2, 'pruneseasonlengthdata.csv'))
wsl <- read.csv(file.path(data2, 'walnutseasonlengthdata.csv'))
